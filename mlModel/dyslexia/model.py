...
# Load the dataset
<<<<<<< HEAD
data = pd.read_csv(r'C:\Users\SAINATH\Documents\Manas-Health\mlModel\dyslexia\Dyslexia.csv')
=======
data = pd.read_csv(r'C:\Users\valli\Desktop\project school\manashealth\mlModel\dyslexia\Dyslexia.csv')
...
dyslexia_final_model = RandomForestClassifier(
...
dyslexia_final_model.fit(X_train, y_train)
y_pred_final = dyslexia_final_model.predict(X_test)
accuracy_final = accuracy_score(y_test, y_pred_final)
print("Final Model Accuracy:", accuracy_final)
joblib.dump(dyslexia_final_model, 'dyslexia_final_model.joblib')
