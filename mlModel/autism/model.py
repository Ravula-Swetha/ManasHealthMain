...
# Load the dataset
<<<<<<< HEAD
data = pd.read_csv(r'C:\Users\SAINATH\Documents\Manas-Health\mlModel\autism\Autism.csv')
=======
data = pd.read_csv(r'C:\Users\valli\Desktop\project school\manashealth\mlModel\autism\Autism.csv')
...
autism_final_model = RandomForestClassifier(
...
autism_final_model.fit(X_train, y_train)
y_pred_final = autism_final_model.predict(X_test)
accuracy_final = accuracy_score(y_test, y_pred_final)
print("Final Model Accuracy:", accuracy_final)
joblib.dump(autism_final_model, 'autism_final_model.joblib')
