...
def predict_severity(user_inputs):
    ...
    model = joblib.load('C://Users//SAINATH//Documents//Manas-Health//mlModel//stress//stress_final_model.joblib')

    # Load the LabelEncoder used during training
    le = joblib.load('C://Users//SAINATH//Documents//Manas-Health//mlModel//stress//label_encoder.joblib')
