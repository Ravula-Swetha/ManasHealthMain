...
# Load the dataset
<<<<<<< HEAD
data = pd.read_csv(r'C:\Users\SAINATH\Documents\Manas-Health\mlModel\stress\Stress.csv')
=======
data = pd.read_csv(r'C:\Users\valli\Desktop\project school\manashealth\mlModel\stress\Stress.csv')
...
stress_final_model = RandomForestClassifier(
...
stress_final_model.fit(X_train, y_train)
y_pred_final = stress_final_model.predict(X_test)
accuracy_final = accuracy_score(y_test, y_pred_final)
print("Final Model Accuracy:", accuracy_final)
joblib.dump(stress_final_model, 'stress_final_model.joblib')
