...
# Load the dataset
<<<<<<< HEAD
data = pd.read_csv(r'C:\Users\SAINATH\Documents\Manas-Health\mlModel\ptsd\Ptsd.csv')
=======
data = pd.read_csv(r'C:\Users\valli\Desktop\project school\manashealth\mlModel\ptsd\Ptsd.csv')
...
ptsd_final_model = RandomForestClassifier(
...
ptsd_final_model.fit(X_train, y_train)
y_pred_final = ptsd_final_model.predict(X_test)
accuracy_final = accuracy_score(y_test, y_pred_final)
print("Final Model Accuracy:", accuracy_final)
joblib.dump(ptsd_final_model, 'ptsd_final_model.joblib')
