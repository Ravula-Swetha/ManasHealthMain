...
# Load the dataset
<<<<<<< HEAD
data = pd.read_csv(r'C:\Users\SAINATH\Documents\Manas-Health\mlModel\adhd\Adhd.csv')
=======
data = pd.read_csv(r'C:\Users\valli\Desktop\project school\manashealth\mlModel\adhd\Adhd.csv')
...
adhd_final_model = RandomForestClassifier(
...
adhd_final_model.fit(X_train, y_train)
y_pred_final = adhd_final_model.predict(X_test)
accuracy_final = accuracy_score(y_test, y_pred_final)
print("Final Model Accuracy:", accuracy_final)
joblib.dump(adhd_final_model, 'adhd_final_model.joblib')
